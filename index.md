...
Household Drinking Water, Sanitation and Hygiene, 2000-2020” 2021). Yet
even for those with water services, unreliable water infrastructure that
provides intermittent supply, or is broken down or abandoned,
contributes to unsustainable and unsafe water access worldwide (Allaire
et al. 2018; Burt et al. 2018; Klug et al. 2018; Valcourt et al. 2020).
...
![Map of the water point locations in the nine
countries](reference/figures/map.png)
...
|:---|:---|:---|
| id | double | Row number assigned during processing |
...
![](reference/figures/README-unnamed-chunk-6-1.png) Based on this pie
chart, it could be interesting to redefine the category “Partially
functional” to gain insights and precision on this aspect of the data.
Most water points are functional: 1333 of 1793.
...
[CC-BY](https://github.com/openwashdata/rwpfunctionality/blob/main/LICENSE.md).
...
#>     keywords = {open data,washdata,water points,functionality,rural water supply,water committees,Ethiopia,India,Malawi,Mali,Mozambique,Nepal,Niger,Rwanda,Uganda,management,open-data,r,wash,water,waterpoint},
#>     version = {0.0.1},
#>   }
```
...
2000-2020: Five Years into the SDGs.” 2021. In *UNICEF DATA*.
