...
#' Africa and South Asia](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2023WR034679)" (Murray, Anna L et al., 2024).
#'
...
#'   \item{wc_mgmt_index_wp}{Overall management index for water committee: 'Inadequate' means WC is inadequate in any of the above indices, 'Minimum' means WC meets minimum level in all above indices ["Operational" Committee], 'Moderate' means WC meets moderate level in all above indices and 'Advanced' means WC meets moderate level in all above indices AND advanced level in at least one of the above}
