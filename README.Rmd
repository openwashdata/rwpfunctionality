...
```
Based on this pie chart, it could be interesting to redefine the category "Partially functional" to gain insights and precision on this aspect of the data. Most water points are functional: `r sum(rwpfunctionality$functional3 == "Functional")` of `r nrow(rwpfunctionality)`.
